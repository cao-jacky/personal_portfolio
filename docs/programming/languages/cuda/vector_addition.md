...
From reading some online tutorials[^1] and guides, this program is supposedly equivalent to the typical "Hello, World!" task when getting started with a new programming language[^2]. My solution can be found [here](https://github.com/cao-jacky/leetgpu/blob/main/vector_addition.cu){:target="_blank"}.
